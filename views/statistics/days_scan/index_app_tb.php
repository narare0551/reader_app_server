<?php
$now_path = '/views/statistics/days_scan/';
?>
<style>
                ...
                <div class="page-content">
                            ...
                            <div class="panel panel-midnightblue mb0" style="border-color:#cccccc;">
                                <div class="panel-body p0" style="inline-height:42px;margin:0px;">
                                    <div action="" class="form-horizontal row-border" style="margin-top:3px" id="search_form" onkeydown="return startSearch(event);">     
                                        <label for="search_start_dttm"  style="float: left; line-height:25px; margin-right:5px" >시작일자</label>               
                                        <input type="text" class=" facnroll-datepicker" style="float: left;margin-right:5px" id="search_start_dttm" placeholder="일자">    
                    ...
                    <div class="row">
                        <div class="col-lg-12" id="main_list">
                            <?php get_include_constents($_SERVER["DOCUMENT_ROOT"].$now_path.'list_app_tb.php'); ?>
                        </div>
                    </div>
                </div>
            </div>
