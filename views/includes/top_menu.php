...
<header id="topnav" class="navbar navbar-midnightblue navbar-fixed-top clearfix" role="banner">
    ...
    <a class="navbar-brand" href="/">FACNROLL</a>
...
<!--        </li>-->
        ...
        <li class="dropdown toolbar-icon-bg">
            ...
            <ul class="dropdown-menu userinfo arrow" style="z-index:999999;">
...
<!--                <li><a href="#"><span class="pull-left">Withdrawals</span> <i class="pull-right fa fa-dollar"></i></a></li>-->
                <li class="divider"></li>
                <li><a href="/login/logout"><span class="pull-left">Sign Out</span> <i class="pull-right fa fa-sign-out"></i></a></li>
            </ul>
        </li>
