...
<!--                                <a href="javascript:getList()" class="btn btn-default" style="background-color: #37474f;color:#ffffff;">검색</a><a href="javascript:addRow();" class="btn btn-default" style="background-color: #37474f;color:#ffffff;">추가</a><a href="javascript:saveForm()" class="btn btn-default" style="background-color: #37474f;color:#ffffff;">저장</a><a href="javascript:removeRow();" class="btn btn-default" style="background-color: #37474f;color:#ffffff;">삭제</a><a href="javascript:location.reload();" class="btn btn-default" style="background-color: #37474f;color:#ffffff;">새로고침</a>-->
                            </div>
                        </div>
