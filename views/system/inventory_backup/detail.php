...
<!--                <div class="col-md-6">-->
<!--                    <div class="form-group">-->
<!--                        <label for="detail_form_stock" class="col-sm-3 control-label" id="label_stock">창고</label>-->
<!--                        <div class="col-sm-9">-->
<!--                            <input type="text" style="text-align: right" class="form-control" id="detail_form_rack_name"-->
<!--                                   placeholder="" readonly>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
<!--                <div class="col-md-6">-->
<!--                    <div class="form-group">-->
<!--                        <label for="detail_form_stock" class="col-sm-3 control-label" id="label_stock">창고위치</label>-->
<!--                        <div class="col-sm-9">-->
<!--                            <input type="text" style="text-align: right" class="form-control" id="detail_form_slave_name"-->
<!--                                   placeholder="" readonly>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
...
<!--                            <div id="grid2" style="width:100%;height:283px;"></div>-->
                            <div id="grid2" style="width:100%;height:339px;"></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="form-horizontal col-md-6">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="label_rack_total" class="col-sm-3 control-label" id="label_rack_total">창고재고</label>
                        <div class="col-sm-9">
                            <input type="text" style="text-align: right" class="form-control"
                                   id="rack_total"
                                   placeholder="">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="label_rack_remain" class="col-sm-3 control-label" id="label_rack_remain">잔여재고</label>
                        <div class="col-sm-9">
                            <input type="text" style="text-align: right" class="form-control"
                                   id="rack_remain"
                                   placeholder="">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel-body" style="height:585px;">
                        <div style="width:100%;overflow-x: scroll">
                            <div id="grid3" style="width:100%;height:585px;"></div>
                        </div>
                    </div>
                </div>
